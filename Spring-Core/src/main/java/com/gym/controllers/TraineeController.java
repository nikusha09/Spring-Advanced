...
public class TraineeController {
    ...
    public ResponseEntity<TraineeProfileResponse> getProfile(@RequestBody String username) {
    ...
    @ApiResponse(responseCode = "401", description = "Authentication failed")
    public ResponseEntity<List<TrainerSummaryResponse>> getUnassignedTrainers(@RequestBody String username) {
    ...
    @ApiResponse(responseCode = "401", description = "Authentication failed")
    public ResponseEntity<List<TraineeTrainingResponse>> getTrainings(@Valid @RequestBody TraineeTrainingsRequest request) {
    ...
    @ApiResponse(responseCode = "401", description = "Authentication failed")
    @ApiResponse(responseCode = "404", description = "Trainee not found")
    public ResponseEntity<Void> activateDeactivate(@Valid @RequestBody ActivateDeactivateRequest request) {
        String username = request.getUsername();
